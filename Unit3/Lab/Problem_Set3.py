...
# that will start up and carry out an interactive Hangman game between a player and the computer. 
...
# Right-click on each and hit "Save Link As". 
# Be sure to save them in same directory. 
# Open and run the file ps3_hangman.py without making any modifications to it, 
...
# The code we have given you loads in a list of words from a file. 
# If everything is working okay, after a small delay, you should see the following printed out:
...
# (defined near the top of the file) to the complete pathname for the file words.txt 
...
# The file ps3_hangman.py has a number of already implemented functions 
# you can use while writing up your solution. 
# You can ignore the code between the following comments, 
# though you should read and understand how to use each helper function by reading the docstrings:
...
# You will want to do all of your coding for this problem 
# within this file as well because you will be writing a program that depends on each function you write.

# Requirements
# The computer must select a word at random from the list of available words that was provided in words.txt. 
# The functions for loading the word list and selecting a random word 
# have already been provided for you in ps3_hangman.py.
...
# do not take away a guess - instead, 
